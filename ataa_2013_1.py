...
w R _ w _ _ _ w _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ w _ _ w
w R _ w _ _ _ w _ A _ _ w w w w w _ _ A _ w _ _ _ w _ _ w
w R _ w _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ w _ _ _ w _ _ w
...
class Tournament1(run.Scenario):
    ...
    SETTINGS = core.Settings(think_time=0.0625, ammo_rate=9, ammo_amount=1, max_score=100000, max_see=70)


#Tournament1.one_on_one(red="domination/agent.py", blue="domination/agent.py", output_folder='_tmp')
Tournament1.test(red="domination/T-600.py", blue="domination/agent.py")
