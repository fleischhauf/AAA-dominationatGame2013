...
info0 = sa0#[qtable0,avrg_policy0,policy0,state_counter0]
info1 = sa1#[qtable1,avrg_policy1,policy1,state_counter1]
info2 = sa2#[qtable2,avrg_policy2,policy2,state_counter2]
total =[info0,info1,info2] # pickle.load(open("stateActionValues-reduced.p3","rb"))
pickle.dump(total, open("q-learning-tables.p","wb"))
print("finished")
