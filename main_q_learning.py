...
f = open("outcome_q_learning_standard_agent.csv","w")
score = 0
ammo = 0
enemyammo = 0
kills = 0
...
for i in range(0, 10):
    ...
    game = core.Game('domination/agent.py', 'domination/q_learning_reduced_space.py',blue_init={'blob': open('q-learning-tables.p','rb')},
